...
SELECT full_name, order_date FROM orders o
...
SELECT product_name, price_per_unit, quantity FROM orders o
...
SELECT c.full_name, p.product_name, oi.quantity FROM Customers c
...
SELECT DISTINCT c.full_name, p.category FROM Customers c
CROSS JOIN Products p

SELECT c.full_name, p.product_name FROM Customers c
CROSS JOIN Products p;

SELECT r.full_name AS recommended_by, c.full_name AS new_customer FROM Customers c
